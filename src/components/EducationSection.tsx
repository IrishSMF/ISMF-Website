      ...
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="basics" className="max-w-4xl mx-auto">
          ...
          <TabsContent value="basics" className="space-y-4 mt-6">
            ...
            <Card className="p-6 bg-navy-mid border border-navy-border">
          ...
          <TabsContent value="metrics" className="space-y-4 mt-6">
            ...
            <Card className="p-6 bg-navy-mid border border-navy-border">
              ...
              <div className="space-y-4">
                ...
                <div className="border-l-4 border-accent bg-navy-light/60 rounded-md pl-4 py-3">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-navy-light border border-navy-border rounded-lg">
