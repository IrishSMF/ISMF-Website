...
const ChartCard = ({ 
  ...
  return (
    <Card className="p-6 bg-[#9CC9F3] border-0 shadow-md rounded-2xl hover:shadow-lg transition-all duration-300 cursor-pointer group">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="max-w-4xl bg-[#FFFCF2] border-[#6184D8]">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#9CC9F3] p-4 rounded-lg border border-[#6184D8]/20">
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[1, 2].map((i) => (
              <Card key={i} className="p-6 bg-[#9CC9F3] border-0 shadow-md rounded-2xl">
